...
import { Phone, X, ShieldCheck } from "@phosphor-icons/react";
import { motion, AnimatePresence } from "framer-motion";
import { useNavigate } from "react-router-dom";
import { loadHotlines, detectUserCountry, type Hotline } from "@/lib/crisisHotlines";

/** Sheet content — controlled by parent. Used from BottomNav. */
...
/** Legacy named export — kept for back-compat but no longer renders a floating FAB. */
