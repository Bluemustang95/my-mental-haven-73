...
import { Wind, HandFist, Flower, BookOpen, Leaf, ArrowRight, Heart } from "@phosphor-icons/react";

const tools = [
  { path: "/herramientas/favoritos", label: "Mi Botiquín", desc: "Tus contenidos favoritos", icon: Heart, color: "bg-destructive/10 text-destructive" },
...
export default function Tools() {
  ...
  return (
    <div className="px-5 pt-14 pb-4 safe-area-top">
      <h1 className="mb-2 font-display text-xl font-semibold">Recursos</h1>
          ...
          return (
            ...
            >
              <div className={`flex h-11 w-11 items-center justify-center rounded-xl ${tool.color}`}>
                <Icon size={22} weight={tool.icon === Heart ? "fill" : "duotone"} />
              </div>
