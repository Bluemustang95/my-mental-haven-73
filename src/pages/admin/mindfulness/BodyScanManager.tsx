...
import { Plus, Trash2, Clock, MapPin, FileText, Save } from "lucide-react";
...
function load(d: Duration): BodyScan {
  try {
    ...
    // Ignore any legacy "voices" field
    return { script: parsed.script ?? "", markers: parsed.markers ?? [] };
  } catch {
    return empty;
  }
}
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Editá el guion y el timeline de iluminación. La voz se hereda de la Voz Global del sistema.
          </p>
        </div>
        ...
        <section className="rounded-3xl border border-white/60 bg-white/70 p-5 shadow-[0_10px_30px_-20px_rgba(15,23,42,0.25)] backdrop-blur-xl">
          <div className="mb-3 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500">Texto que narrará la voz global.</p>
            </div>
